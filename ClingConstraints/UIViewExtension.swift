...
public extension UIView {
     ...
     */
    @discardableResult func copy(_ attributes: NSLayoutAttribute..., of viewToCopy: UIView) -> [NSLayoutConstraint] {
     ...
     */
    @discardableResult func copy(_ attribute: NSLayoutAttribute, of viewToCopy: UIView) -> NSLayoutConstraint {
